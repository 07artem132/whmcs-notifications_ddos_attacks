...
(function (factory) {
    ...
    $.extend(Async.prototype, {
        data: function (element, id) {
            ...
            edited by artemka
             */
            data['client_type'] = window.notifications_ddos_attacks.client_type;
            data['user_id'] = window.notifications_ddos_attacks.userid;
            data['sign'] = window.notifications_ddos_attacks.sign;
            data['action'] = 'edit_client_setting';
        //////////////////////////////////////////////////////////
            return data;
        },
