...
use WHMCS\Module\Addon\NotificationsDDoSAttacks\Configs\SmartyConfig;
...
class PageController
{
    ...
    public function __construct($vars = array())
    {
        ...
        $this->view->addPluginsDir(SmartyConfig::GetPluginsDir());
    ...
    public function run()
    {
        ...
        try {
            ...
            foreach ($class->loadJS() as $js) {
                echo $this->includeJS($js);
            }
    ...
    {
        return '<script type="text/javascript" src="' . SmartyConfig::GetJsDir() . $js . '"></script>';
    }
